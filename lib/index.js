 ...
 * @param params
 * @param needsCookie
 * @param {string | string | string | string} term A valid term code
 * @returns {Promise<string[]>} A Promise containing the cookie returned by the server
 */
...
/**
  ...
  * @param method
  * @param school
  * @param {number | number | string | string | string} school The school name as given from the list of supported schools
...
module.exports = { // Class makes it easier more readbale imo
    /**
    * @param offset
    * @param max
   * @param {nummber | number}
   * @returns {Promise<any>}
   */
    ...
    * @param offset
    * @param max
     * @param {string | number | number } term - valid term code, and offset/ mac stays @1
     * @returns {Promise<any>}
     */
    ...
    /**
     * @param terms
     * @param {term} term valid term code
     * @returns {Promise<[]>}
     */
     ...
     * @param pageSize
     * @param offset
     * @param {number | string | number | number | string} term - a valid term code, subject...
     * @returns {Promise<*>}
     */
